...
function header_2() {
    return (
        <nav style = {headerStyle}>
            ...
            <Link onClick = {scrollToTop} style = {linkStyle}to="/KentRidge2" className = "Linkbtn" activeStyle = {{color: "rgb(221, 160, 95)"}}>Kent Ridge</Link>
            <Link onClick = {scrollToTop} style = {linkStyle}to="/about" className = "Linkbtn" activeStyle = {{color: "rgb(221, 160, 95)"}}>About</Link>
